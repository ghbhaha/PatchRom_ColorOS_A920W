...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/app/ActivityThread$PromptThread;,
...
.method static synthetic access$3600(Landroid/app/ActivityThread;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->amoiLog(Ljava/lang/String;)V
...
.method private convertAppWantToFieldColumn(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .parameter "appWantTo"
    ...
    .local v0, fieldColumn:Ljava/lang/String;
    ...
    const-string v1, "com.android.email.notifier"
    ...
    :cond_f
    const-string v0, "access4"

    goto/16 :goto_0

    :cond_10
    const-string v1, "com.android.gallery3d.filtershow.provider.SharedImageProvider"
...
.method private getCallerPermission(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)Landroid/app/ActivityThread$PermissionMode;
    .locals 1
    .parameter "context"
    ...
    .prologue
    sget-object v0, Landroid/app/ActivityThread$PermissionMode;->ALLOW:Landroid/app/ActivityThread$PermissionMode;
...
.method private getPromptString(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)Ljava/lang/String;
    .locals 9
    .parameter "context"
    .parameter "providerInfo"
    .parameter "name"
    ...
    .local v0, appDisplayName:Ljava/lang/String;
    new-instance v5, Ljava/lang/StringBuilder;
    ...
    const-string v6, "getPromptString:"
    ...
    invoke-direct {p0, v5}, Landroid/app/ActivityThread;->amoiLog(Ljava/lang/String;)V

    return-object v2

    .end local v0           #appDisplayName:Ljava/lang/String;
...
.method private showCheckUserPermissionDialog(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .parameter "context"
    .parameter "providerInfo"
    .parameter "appWant"
    ...
    invoke-interface {v0, p3, v1}, Landroid/app/IActivityManager;->putCheckingAppStatus(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Landroid/app/ActivityManagerNative;->getDefault()Landroid/app/IActivityManager;

    move-result-object v0

    invoke-direct {p0, p1, p2, p4}, Landroid/app/ActivityThread;->getPromptString(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, p3, v1}, Landroid/app/IActivityManager;->showCheckUserPermissionDialog(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
